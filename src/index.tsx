...
5. 完全なJSON（{で始まり}で終わる）を出力すること`
    ...
    for (let attempt = 1; attempt <= MAX_RETRIES; attempt++) {
      ...
      body: JSON.stringify({
        ...
        generationConfig: {
          temperature: 0.2,
          maxOutputTokens: 32768,  // 16384 → 32768 に増加（gemini-3-pro-preview は最大32K対応）
          topP: 0.9,
          topK: 20
        }
      })
    ...
    <body>
      ...
      <script>
        ...
        function drawStatic() {
          ...
          // 4グループのリンゴ（間隔を詰めて余裕を持たせる）
          const groups = [
            { label: '1つめ', x: 175, y: 230 },
            { label: '2つめ', x: 315, y: 230 },
            { label: '3つめ', x: 455, y: 230 },
            { label: '4つめ', x: 595, y: 230 }
          ];
