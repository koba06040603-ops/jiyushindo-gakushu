...
5. 完全なJSON（{で始まり}で終わる）を出力すること`
    ...
    const modelName = 'gemini-2.5-flash'  // 最新の Gemini 2.5 Flash
...
`
    ...
    if (useHighQuality) {
      ...
      models = [
        { name: 'gemini-2.5-flash', maxTokens: 16384 }  // Proのみ
      ]
      generationConfig = {
      ...
      models = [
        ...
        { name: 'gemini-2.5-flash', maxTokens: 16384 },     // 高速
        { name: 'gemini-2.5-flash', maxTokens: 16384 }        // 最高品質（フォールバック）
      ]
      generationConfig = {
        temperature: 0.7,
        maxOutputTokens: 16384,
