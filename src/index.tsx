...
function getGradeLanguageRule(grade: string | undefined): string {
  ...
  const rules: { [key: string]: string } = {
    '小学1年': 'ひらがなを中心に使う。漢字は「一、二、三、人、子」など習った漢字のみ。1文は短く10文字程度。',
    '小学2年': 'やさしい漢字（学年、時間、海、算数など）を使える。1文は15文字程度。具体的な例えを使う。',
    '小学3年': '小学3年生までの漢字を使える。「問題、考える、答え」など。1文は20文字程度。',
    '小学4年': '小学4年生までの漢字を使える。「説明、例、関係」など。やや抽象的な言葉も使える。',
    '小学5年': '小学5年生までの漢字を使える。「条件、過程、要素」など。論理的な説明ができる。',
    '小学6年': '小学6年生までの漢字を使える。「構成、機能、影響」など。複雑な説明も可能。',
    '中学1年': '中学生レベルの言葉を使える。専門用語も適度に使用。',
    '中学2年': '中学生レベルの言葉を使える。専門用語も適度に使用。',
    '中学3年': '中学生レベルの言葉を使える。専門用語も適度に使用。'
  }
